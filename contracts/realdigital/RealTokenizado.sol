...
contract RealTokenizado is RealDigital {
    ...
    */
    ...
    /**
     * Gasta o allowance do token, usado no Swap
     * @param owner Dono do token
     * @param spender Quem vai gastar o allowance, no caso o contrato de swap
     * @param amount Quantidade
     */
    function spendAllowanceFrom( address owner, address spender, uint256 amount) public  onlyRole(BURNER_ROLE) {
